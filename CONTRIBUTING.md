Contributing to MRV_Coin
============================

The MRV_Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/mrv_coin-project/mrv_coin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the MRV_Coin project, and is not to be
confused with overall MRV_Coin Network Protocol consensus changes.

Whether a pull request is merged into MRV_Coin rests with the project merge
...
Patches that change MRV_Coin consensus rules are considerably more involved than
...
Where a patchset proposes to change the MRV_Coin consensus, it must have been
...
The project leader is the release manager for each MRV_Coin release.
