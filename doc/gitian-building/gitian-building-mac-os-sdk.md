...
The script [extract-osx-sdk.sh](https://github.com/mrv_coin-project/mrv_coin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
mrv_coin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/mrv_coin-project/mrv_coin/blob/master/doc/README_osx.md) for troubleshooting tips.
