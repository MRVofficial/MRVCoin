...
The build script we'll be using is contained in the MRV_Coin github repository ([contrib/gitian-build.py](https://github.com/mrv_coin-project/mrv_coin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the MRV_Coin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/MRV_Coin-Project/MRV_Coin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, mrv_coin-detached-sigs, and mrv_coin GitHub repos.
