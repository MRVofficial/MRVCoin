...
This document provides guidelines for internationalization of the MRV_Coin software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to MRV_Coin network</source>
        <translation>
            <numerusform>%n active connection to MRV_Coin network</numerusform>
            <numerusform>%n active connections to MRV_Coin network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `mrv_coin_en.ts` remains unchanged.
