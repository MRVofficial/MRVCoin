...
RESOURCES += src/qt/mrv_coin.qrc src/qt/mrv_coin_locale.qrc

TRANSLATIONS += src/qt/locale/mrv_coin_bg.ts \
                src/qt/locale/mrv_coin_de.ts \
                src/qt/locale/mrv_coin_en.ts \
                src/qt/locale/mrv_coin_es.ts \
                src/qt/locale/mrv_coin_fi.ts \
                src/qt/locale/mrv_coin_fr.ts \
                src/qt/locale/mrv_coin_it.ts \
                src/qt/locale/mrv_coin_ja.ts \
                src/qt/locale/mrv_coin_pl.ts \
                src/qt/locale/mrv_coin_pt.ts \
                src/qt/locale/mrv_coin_ru.ts \
                src/qt/locale/mrv_coin_sk.ts \
                src/qt/locale/mrv_coin_sv.ts \
                src/qt/locale/mrv_coin_vi.ts \
                src/qt/locale/mrv_coin_zh_CN.ts \
                src/qt/locale/mrv_coin_zh_TW.ts
