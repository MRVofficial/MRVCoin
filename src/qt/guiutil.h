...
/** Utility functions used by the MRV_Coin Qt UI.
 */
namespace GUIUtil
{
...
// Render MRV_Coin addresses in monospace font
...
// Parse "mrv_coin:" URI into recipient object, return true on successful parsing
