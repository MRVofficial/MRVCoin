...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            MRV_CoinGUI* window = static_cast<MRV_CoinGUI*>(parentWidget());
...
{
    MRV_CoinGUI* gui = static_cast<MRV_CoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<MRV_CoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("MRV Coin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your MRVs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
