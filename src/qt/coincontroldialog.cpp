...
void CoinControlDialog::updateLabels()
{
    ...
    int nDisplayUnit = BitcoinUnits::MRV;
    ...
    for (PAIRTYPE(QString, std::vector<COutput>) coins : mapCoins) {
        ...
        for(const COutput& out: coins.second) {
            ...
            if (haveDest) {
                ...
                // if listMode or change => show MRV_Coin address. In tree mode, address is not shown again for direct wallet address outputs
