...
/* MRV_Coin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "MRV Coin"
#define QAPP_ORG_DOMAIN "mrv_coin.org"
#define QAPP_APP_NAME_DEFAULT "MRV Coin-Qt"
#define QAPP_APP_NAME_TESTNET "MRV Coin-Qt-testnet"
