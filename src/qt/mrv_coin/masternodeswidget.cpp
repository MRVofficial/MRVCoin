...
#include "qt/mrv_coin/forms/ui_masternodeswidget.h"

#include "qt/mrv_coin/qtutils.h"
#include "qt/mrv_coin/mnrow.h"
#include "qt/mrv_coin/mninfodialog.h"
#include "qt/mrv_coin/masternodewizarddialog.h"
...
#include "util.h"
#include "qt/mrv_coin/optionbutton.h"
#include <iostream>
#include <fstream>
...
MasterNodesWidget::MasterNodesWidget(MRV_CoinGUI *parent) :
    PWidget(parent),
    ...
    if (fs::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:2362 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= GetMNCollateral(0) * COIN) {
        inform(tr("Not enough balance to create a masternode, %1 MRV required.").arg(GetMNCollateral(0)));
        return;
    }
    showHideOp(true);
