...
#ifndef MRV_Coin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define MRV_Coin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //MRV_Coin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
