...
#include "qt/mrv_coin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/mrv_coin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(MRV_CoinGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
	...
	messageInternal(CMD_REPLY, (tr("Welcome to the MRV Coin RPC console.") + "<br>" +
