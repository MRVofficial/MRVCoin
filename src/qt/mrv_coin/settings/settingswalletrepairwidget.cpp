...
#include "qt/mrv_coin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/mrv_coin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(MRV_CoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to MRV_CoinGUI::handleRestart()
