...
#include "qt/mrv_coin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(MRV_CoinGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("MRV_Coin_tx_csv_export(*.csv)") : tr("MRV_Coin_addresses_csv_export(*.csv)"),
                                        nullptr);
