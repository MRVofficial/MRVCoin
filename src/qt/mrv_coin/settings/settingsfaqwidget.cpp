...
#include "qt/mrv_coin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/mrv_coin/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(MRV_CoinGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableMRV,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableMRV,
    ...
    connect(ui->pushButton_UnspendableMRV, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableMRV);});
    ...
    if (parent)
        connect(parent, &MRV_CoinGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
