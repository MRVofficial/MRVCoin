...
#include "qt/mrv_coin/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(MRV_CoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &MRV_CoinGUI::openFAQ);
