...
#include "qt/mrv_coin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(MRV_CoinGUI* _window, QWidget *parent) :
