...
#include "qt/mrv_coin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/mrv_coin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(MRV_CoinGUI* _window, QWidget *parent) :
