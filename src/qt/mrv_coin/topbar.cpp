...
#include "qt/mrv_coin/topbar.h"
#include "qt/mrv_coin/forms/ui_topbar.h"
#include "qt/mrv_coin/lockunlock.h"
#include "qt/mrv_coin/qtutils.h"
#include "qt/mrv_coin/receivedialog.h"
#include "qt/mrv_coin/loadingdialog.h"
...
TopBar::TopBar(MRV_CoinGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopMrv}, "amount-small-topbar");
    setCssProperty({ui->labelAmountMrv}, "amount-topbar");
    setCssProperty({ui->labelPendingMrv, ui->labelImmatureMrv}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("MRV_Coin")
    updateDisplayUnit();
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // MRV Total
    QString totalMrv = GUIUtil::formatBalance(balance, nDisplayUnit);

    // MRV
    // Top
    ui->labelAmountTopMrv->setText(totalMrv);
    // Expanded
    ui->labelAmountMrv->setText(totalMrv);
    ui->labelPendingMrv->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelImmatureMrv->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
}
