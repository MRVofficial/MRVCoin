...
#include "qt/mrv_coin/forms/ui_addresseswidget.h"
#include "qt/mrv_coin/addresslabelrow.h"
#include "qt/mrv_coin/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(MRV_CoinGUI* parent) :
    PWidget(parent),
...
void AddressesWidget::onStoreContactClicked()
{
    if (walletModel) {
        ...
        if (walletModel->updateAddressBookLabels(mrvAdd, label.toUtf8().constData(),
