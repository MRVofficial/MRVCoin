...
#include "qt/mrv_coin/sendcustomfeedialog.h"
#include "qt/mrv_coin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(MRV_CoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &MRV_CoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
