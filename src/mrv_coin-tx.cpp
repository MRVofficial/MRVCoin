...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MRV_Coin mrv_coin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mrv_coin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mrv_coin transaction") + "\n" +
                               "  mrv_coin-tx [options] -create [commands]   " + _("Create hex-encoded mrv_coin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mrv_coin transaction
