...
/** 
    ...
    ****Note - for MRV_Coin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of mrv_coin coming in to a transaction
