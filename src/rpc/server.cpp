...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop MRV Coin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "MRV Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MRV_Coin features */
        {"mrv_coin", "listmasternodes", &listmasternodes, true, true, false},
        {"mrv_coin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mrv_coin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"mrv_coin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"mrv_coin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"mrv_coin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mrv_coin", "masternodedebug", &masternodedebug, true, true, false},
        {"mrv_coin", "startmasternode", &startmasternode, true, true, false},
        {"mrv_coin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mrv_coin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mrv_coin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mrv_coin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mrv_coin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mrv_coin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mrv_coin", "preparebudget", &preparebudget, true, true, false},
        {"mrv_coin", "submitbudget", &submitbudget, true, true, false},
        {"mrv_coin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mrv_coin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mrv_coin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mrv_coin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mrv_coin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mrv_coin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mrv_coin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mrv_coin", "checkbudgets", &checkbudgets, true, true, false},
        {"mrv_coin", "mnsync", &mnsync, true, true, false},
        {"mrv_coin", "spork", &spork, true, true, false},
...
{
    return "> mrv_coin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:2361/\n";
}
